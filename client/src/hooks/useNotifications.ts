...
export const useNotifications = () => {
  ...
  useEffect(() => {
    // Only initialize mock notifications once when the hook is first used
      ...
      const mockNotifications: Notification[] = [
        {
          ...
          message: 'You have been assigned to help with Community Garden Cleanup on Saturday at 9 AM.',
        ...
        },
        {
          ...
          message: 'Complete your profile to get better volunteer matches. You\'re 80% done!',
